      ...
      <header className="border-b border-slate-800/80 bg-slate-900/60 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => navigate('dashboard')}>
            ...
            <div>
              <span className="font-bold text-base text-slate-100 tracking-tight">Uniplexity</span>
              <span className="text-xs text-indigo-400 font-semibold ml-1.5 px-2 py-0.5 rounded-full bg-indigo-500/10 border border-indigo-500/20">
                Migration Agent
              </span>
            </div>
          </div>
