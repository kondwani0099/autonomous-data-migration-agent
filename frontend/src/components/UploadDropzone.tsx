...
export const UploadDropzone: React.FC<UploadDropzoneProps> = ({ onFilesSelected }) => {
  ...
  return (
    <div className="w-full">
      <label
        htmlFor="file-upload"
        className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-slate-300 dark:border-slate-700/80 rounded-2xl cursor-pointer bg-slate-50 dark:bg-slate-900/40 hover:bg-slate-100 dark:hover:bg-slate-900/80 hover:border-indigo-500/50 transition-all duration-300 group"
      >
