    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="glass-card p-5 flex items-center space-x-4">
          ...
          <div>
            <p className="text-xs text-slate-400">Records Imported</p>
        ...
        <div className="glass-card p-5 flex items-center space-x-4">
          ...
          <div>
            <p className="text-xs text-slate-400">Clarifications Needed</p>
            <p className="text-xl font-bold text-slate-100">
      ...
      <div className="glass-card p-6 space-y-4">
        <h3 className="text-base font-semibold text-slate-200">Recent Migration Jobs</h3>
        {jobs.length === 0 ? (
          ...
          <div className="space-y-3">
            {jobs.map((job) => (
              <div
                ...
                className="flex items-center justify-between p-4 rounded-xl bg-slate-900/40 border border-slate-800 hover:border-indigo-500/50 cursor-pointer transition-all duration-200"
              >
                <div>
                  <h4 className="text-sm font-semibold text-slate-200">{job.client_name}</h4>
                  <p className="text-xs text-slate-400 font-mono mt-0.5">{job.job_id}</p>
                </div>
                <div className="flex items-center space-x-4">
                  <span className="text-xs px-3 py-1 rounded-full font-mono bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                    {job.status}
                  </span>
